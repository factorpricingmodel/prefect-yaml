...
Prefect YAML could always use more documentation, whether as part of the official Prefect YAML docs, in docstrings, or even on the web in blog posts, articles, and such.
...
2. Clone your fork locally:
   ...
   ```shell
   $ git clone git@github.com:your_name_here/prefect-yaml.git
   ```
...
2. Update the version in both the setup file `pyproject.toml` and package
   file `src/prefect_yaml/__init__.py`
...
[gh-issues]: https://github.com/factorpricingmodel/prefect-yaml/issues
